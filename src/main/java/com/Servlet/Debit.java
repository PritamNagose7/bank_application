...
public class Debit extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		out.print("<table>");
		out.print("<tr><td></td><td><input type='text' name='accountnumber'  value='" + acn.getAccountnumber()
				+ "'/></td></tr>");
		out.print("<tr><td>Current Balance:</td><td><input type='text' id ='first' name='name' value='"
				+ acn.getBalance() + "'/></td></tr>");
		out.print("<tr><td>Debit:</td><td><input type='number'id='second' name='new'></td></tr>");
		out.print("<tr><td>Total:</td><td><input type='number' id='answer' name='Balance'></td></tr>");
		out.print("<button onclick=\"min()\">Deb</button>");
		out.print("</form>");
